...
if __name__ == '__main__':
    ...
    parser.add_argument('--histogram'      , type=str, required=True, help=".hit file produced by abyss")
    parser.add_argument('--min-limit'      , type=int, required=True, help="lower x-limit")
    parser.add_argument('--max-limit'      , type=int, required=True, help="upper x-limit")
    parser.add_argument('--kmer'           , type=int, required=True, help="kmer employed, if you do not know guess a number")
    parser.add_argument('--output-name'    , type=str, required=True, help="output name (.png)")
