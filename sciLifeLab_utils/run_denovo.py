...
@click.option('--lineage',  type=click.Choice(['eukarya', 'bacteria', 'vertebrata', 'none']), required=True, 
        help="Used for running BUSCO. Which taxa does the organism belong to, the lower taxa will contian more target genes," 
